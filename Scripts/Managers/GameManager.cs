...
public class GameManager : MonoBehaviour {
    ...
    public int numberofdotscollected;
    public string playerWinOrLose;
    private bool timerIsActive = true;
    static public int dotNumber = 0;
	...
	void Start () 
	{
        ...
        InvokeRepeating("Player_Y", 0f, 1);  //0 delay, repeat every 1s
    ...
    public void ResetRound(){
        ...
        Tinylytics.AnalyticsManager.LogCustomMetric("Prolific ID: " + initials_input + " trial Number: " + trialNum.ToString() + "_" + trials[trialNum-1]+" trialName: "+trialName + " trialTime: "+ trialTimer.ToString()+" playerScore: "+ score.ToString()+" playerCollectDots: "+ dotNumber.ToString(),"player position: "+str);
